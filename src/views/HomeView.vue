...
<template>
    <section id="story" class="description_content">
        <div class="text-content container">
            <div class="col-md-6">
                <h1>EL SABOR DEL POLLO</h1>
                <div class="fa fa-cutlery fa-2x"></div>
                <p class="desc-text">
                    "El Sabor del Pollo", donde en cada bocado resalta el sabor en nuestros productos.
                    Utilizamos solo los ingredientes más frescos, garantizando un sabor único y una textura
                    crujiente. Para vengas con la familia, con amigos o simplemente desees un almuerzo rápido,
                    nuestro ambiente acogedor y un servicio al cliente excepcional te harán sentir como en
                    casa. "El Sabor del Pollo" es la elección preferida de quienes buscan calidad, sabor y una
    ...
    <section id="pricing" class="description_content">
        <div class="pricing background_content">
            <h1>Hechos con ingredientes naturales</h1>
        </div>
        <div class="text-content container">
            <div class="container">
                <div class="row">
                    <div id="w">
                        <ul id="filter-list" class="clearfix"></ul>
                        <!-- @end #filter-list -->
                        <ul id="portfolio">
    ...
    <section id="beer" class="description_content">
        ...
        <div class="text-content container">
            ...
            <div class="col-md-6 col-md-offset-1">
                <h1>Nuestras Bedidas</h1>
                <div class="icon-beer fa-2x"></div>
                <p class="desc-text">
                    En nuestra Broastería no solo ofrecemos comida, sino también una variedad de gaseosas para
                    que disfrute como acompañante de su comida, entre estas la más consumida Coca Cola.
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="bread" class="description_content">
        ...
        <div class="text-content container">
            <div class="col-md-6">
                ...
                <p class="desc-text">
                    Para los amantes del sabor les ofrecemos una variedad de salsas como ser mayonesa,
                    ketchup, mostaza, llajua, entre otros.
                </p>
            </div>
            <div class="col-md-6">
    ...
    <section id="featured" class="description_content">
        ...
        <div class="text-content container">
            <div class="col-md-6">
                ...
                <p class="desc-text">
                    Respecto al menú, ofrecemos un menú dirigido a la comida rápida, para que no tengas que
                    esperar horas por un plato, nosotros te ofrecemos pollo a la Broaster, Hamburguesas, entre
                    otros.
                </p>
            </div>
            <div class="col-md-6">
        ...
        <div class="text-content container">
            <div class="col-md-6">
                ...
                <ul class="social_icons">
                    <li>
                        <a class="icon-facebook color_animation" href="https://www.facebook.com/polloskiky"
                            target="_blank"><img
                                src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg"
                                alt="Facebook" width="30" height="30" /></a>
                    </li>
                    <li>
                        <a class="icon-instagram color_animation" href="https://www.instagram.com/tiokiky/"
                            target="_blank">
            ...
            <div class="col-md-4">
                <span class="social_heading">CONTACTANOS</span>
                <span class="social_info"><a class="color_animation" href="tel:74440470">74440470</a></span>
            </div>
        </div>
    </section>
